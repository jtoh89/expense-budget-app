...
export default function ConfigsPage() {
	...
	const handleEditSubcategory = async (id: string, categoryId: string, name: string) => {
		try {
		...
		<div className="mx-auto max-w-7xl px-6 py-8">
			...
			<div className="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
				{loading ? (
					...
					<div className="py-12 text-center text-gray-500">No cards yet. Click &quot;Add Card&quot; to create one.</div>
				) : (
						...
						<table className="w-full min-w-[400px]">
							<thead>
								<tr className="bg-gray-50">
									...
									<th className="px-4 py-3 text-left text-sm font-semibold text-gray-700">Card Name</th>
									<th className="px-4 py-3 text-right text-sm font-semibold text-gray-700">Edit</th>
								</tr>
							</thead>
							<tbody>
								{cards.map((row) => (
			...
			<div className="mt-8">
				...
				<div className="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
					{categoriesLoading ? (
						...
						<div className="py-12 text-center text-gray-500">No categories yet. Click &quot;Add Category&quot; to create one.</div>
					) : (
						<div className="overflow-x-auto">
							<table className="w-full min-w-[400px]">
								<thead>
			...
			<div className="mt-8">
				...
				<div className="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
					{subcategoriesLoading ? (
						...
						<div className="py-12 text-center text-gray-500">No subcategories yet. Click &quot;Add Subcategory&quot; to create one.</div>
					) : (
						<div className="overflow-x-auto">
							<table className="w-full min-w-[400px]">
								<thead>
							...
							<table className="w-full min-w-[400px]">
								<thead>
									<tr className="bg-gray-50">
										...
										<th className="px-4 py-3 text-right text-sm font-semibold text-gray-700">Edit</th>
										<th className="px-4 py-3 text-right text-sm font-semibold text-gray-700">Delete</th>
									</tr>
								</thead>
								<tbody>
									{skipKeywords.map((keyword) => (
										<tr key={keyword} className="border-t border-gray-100 hover:bg-gray-50">
											<td className="px-4 py-3 text-sm text-gray-700">{keyword}</td>
											<td className="px-4 py-3 text-right">
												<button
													type="button"
